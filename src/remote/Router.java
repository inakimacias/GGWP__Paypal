...
public class Router extends Thread {
	...
	private PayingService ps = PayingService.getInstance();
	...
	public void run() {
		...
		try {
			...
			case "pay":
				System.out.println(" - Router - Routing to Paying Service as PaypalID:"+goodData.get(1)+", Change:"+goodData.get(2));
				data = ps.efectuarPago(goodData.get(1), goodData.get(2));
				break;
			default:
